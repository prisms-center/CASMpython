...
plot_type_cls = [
    cp_hist.PlotHistCommand, cp_hull.PlotHullCommand,
    cp_layout.PlotLayoutCommand, cp_rankplot.PlotRankplotCommand,
...
def main(argv=None):
    ...
    parser.add_argument('args',
                        help="Plotting arguments",
                        nargs=argparse.REMAINDER,
                        metavar="...")
    parser.add_argument('--desc',
                        help="Print plot type list",
                        action="store_true",
                        default=False)
