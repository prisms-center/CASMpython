...
project = u'CASM'
copyright = u'2018, CASM Developers'
...
latex_documents = [
    (master_doc, 'CASM.tex', u'CASM Documentation', u'CASM Developers',
     'manual'),
]
...
man_pages = [(master_doc, 'casm', u'CASM Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'CASM', u'CASM Documentation', author, 'CASM',
